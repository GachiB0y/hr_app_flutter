  ...
  Widget build(BuildContext context) => Padding(
        ...
        child: ElevatedButton(
          onPressed: () {
            ...
            // final value = ExchangeCoinForPassScope.of(context).state.controller.text;
            // if (value.isEmpty) {
            //   return;
            // }
        ...
        children: [
          Row(
            ...
            children: <Widget>[
              IconButton(
                onPressed: () {
                  final state = ExchangeCoinForPassScope.of(context, listen: false).state;
              ...
              ConstrainedBox(
                ...
                child: IntrinsicWidth(
                  child: DecoratedBox(
                    ...
                    child: TextField(
                      controller: ExchangeCoinForPassScope.of(context).state.controller,
