...
class WalletProviderImpl implements IWalletProvider {
  ...
  Future<({int balance, int avarageCoins})> getBalance() async {
    ...
    if (response case {'result': final Map<String, Object?> data}) {
      final balance = data['coins']! as int;
      final avarageCoins = data['avarage_coins']! as int;
  ...
  Future<int> sendCoinsToOtherUser({
    ...
    if (response case {'result': final Map<String, Object?> data}) {
      final result = data['coins']! as int;
      return result;
    }
  ...
  Future<List<CoinsReward>> getInfoCoinsReward() async {
    ...
    if (response case {'result': final data as List<dynamic>}) {
      final result = data
          .map((item) => CoinsReward.fromJson(item as Map<String, dynamic>))
          .toList();
  ...
  @override
  Future<List<CoinsReward>> getCoinsInfo() async {
