  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<LeanProductionFormBloc, LeanProductionFormState>(
        ...
        listener: (context, state) {
          if (state is LeanProductionFormState$Successful) {
            if (state.data!.isSubmitting == true) {
          ...
          } else if (state is LeanProductionFormState$Error) {
            ScaffoldMessenger.of(context)
              ..hideCurrentSnackBar()
              ..showSnackBar(
                SnackBar(
                      ...
                      onChanged: (value) {
                        if (value.isNotEmpty) {
                          ...
                          searchDebounce =
                            ...
                            otherUsersBloc.add(
                                OtherUsersEvent.findUsers(findText: value));
                          });
                        }
                      },
                    ),
